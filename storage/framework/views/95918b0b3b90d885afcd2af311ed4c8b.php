...
<section class="hero">
    <video autoplay muted loop playsinline>
        <source src="<?php echo e(asset('video/horses.mp4')); ?>" type="video/mp4">
    </video>
        ...
        <div class="row g-4 align-items-start">
            <div class="col-lg-5">
                <video autoplay muted loop playsinline class="w-100 rounded">
                    <source src="<?php echo e(asset('video/gaucho-left.mp4')); ?>" type="video/mp4">
                </video>
                <div class="mt-4">
            ...
            <div class="col-lg-7">
                <div class="ratio ratio-16x9 rounded overflow-hidden">
                    <video autoplay muted loop playsinline class="w-100 h-100 object-fit-cover">
                        <source src="<?php echo e(asset('video/gaucho-right.mp4')); ?>" type="video/mp4">
                    </video>
                </div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4">
                <article class="trip-card">
                    <img src="<?php echo e(asset('images/upcoming-1.jpg')); ?>" alt="" class="w-100 mb-3">
            ...
            <div class="col-md-6 col-lg-4">
                <article class="trip-card">
                    <img src="<?php echo e(asset('images/upcoming-2.jpg')); ?>" alt="" class="w-100 mb-3">
            ...
            <div class="col-md-6 col-lg-4">
                <article class="trip-card">
                    <img src="<?php echo e(asset('images/upcoming-3.jpg')); ?>" alt="" class="w-100 mb-3">
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-lg-5">
                ...
                <a href="<?php echo e(route('experiences', ['lang'=>app()->getLocale()])); ?>" class="btn btn-pill mt-2">Explore
                    Options</a>
            </div>
            <div class="col-lg-7">
                <div class="row g-3 mosaic">
                    <div class="col-4"><img src="<?php echo e(asset('images/exp-1.jpg')); ?>" alt=""></div>
                    <div class="col-4"><img src="<?php echo e(asset('images/exp-2.jpg')); ?>" alt=""></div>
                    <div class="col-4"><img src="<?php echo e(asset('images/exp-3.jpg')); ?>" alt=""></div>
                    <div class="col-4 d-none d-md-block"><img src="<?php echo e(asset('images/exp-4.jpg')); ?>" alt=""></div>
                    <div class="col-4 d-none d-md-block"><img src="<?php echo e(asset('images/exp-5.jpg')); ?>" alt=""></div>
                    <div class="col-4 d-none d-md-block"><img src="<?php echo e(asset('images/exp-6.jpg')); ?>" alt=""></div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 align-items-center" id="tailored">
            ...
            <div class="col-lg-7">
                <div class="row g-3">
                    <div class="col-md-6"><img src="<?php echo e(asset('images/tailored-1.jpg')); ?>" class="w-100 rounded" alt="">
                    </div>
                    <div class="col-md-6"><img src="<?php echo e(asset('images/tailored-2.jpg')); ?>" class="w-100 rounded" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                <img src="<?php echo e(asset('images/about-bw.jpg')); ?>" alt="Founders" class="about-img" style="height:520px;">
            </div>
            <div class="col-lg-6">
...
<section class="py-5" style="background:#faf9f6;">
    <div class="container">
        ...
        <div class="d-flex flex-wrap align-items-center gap-4 partners">
            <img src="<?php echo e(asset('images/partner-1.png')); ?>" alt="Partner 1">
            <img src="<?php echo e(asset('images/partner-2.png')); ?>" alt="Partner 2">
            <img src="<?php echo e(asset('images/partner-3.png')); ?>" alt="Partner 3">
            <img src="<?php echo e(asset('images/partner-4.png')); ?>" alt="Partner 4">
            <img src="<?php echo e(asset('images/partner-5.png')); ?>" alt="Partner 5">
        </div>
    </div>
</section>
...
<footer class="footer-hero">
    <div class="inner container">
        ...
        <div class="text-end small mt-5">© <?php echo e(date('Y')); ?> by BA Polo Day</div>
    </div>
</footer>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\salvaCastro\Documents\proyectos\baPoloDay\resources\views/home.blade.php ENDPATH**/ ?>